...
Revision ID: f6b455b52673
Revises: 
Create Date: 2025-11-25 04:06:53.209924
...
def upgrade():
    ...
    # 2. Users (BREAKING CYCLE: Removing FK to units initially)
    ...
    sa.Column('unit_id', sa.Integer(), nullable=True), # FK added later
    ...
    sa.Column('twitter_profile', sa.String(length=255), nullable=True),
    sa.Column('facebook_profile', sa.String(length=255), nullable=True),
    sa.Column('instagram_profile', sa.String(length=255), nullable=True),
    sa.Column('linkedin_profile', sa.String(length=255), nullable=True),
    sa.Column('tiktok_profile', sa.String(length=255), nullable=True),
    sa.PrimaryKeyConstraint('id'),
    ...
    # 3. Condominiums (Depends on users)
    ...
    sa.Column('document_code_prefix', sa.String(length=10), nullable=True),
    sa.Column('status', sa.String(length=30), nullable=True),
    ...
    sa.ForeignKeyConstraint(['billing_contact_id'], ['users.id'], name='fk_condominium_billing_contact'),
    ...
    # 4. Units (Depends on condominiums and users)
    ...
    # 5. Closing the cycle: Add FK to users -> units
    op.create_foreign_key('fk_users_unit', 'users', 'units', ['unit_id'], ['id'])
    ...
    sa.Column('document_code', sa.String(length=50), nullable=True),
    ...
    sa.Column('proof_of_payment', sa.String(length=500), nullable=True),
...
def downgrade():
    # Remove FK first
    op.drop_constraint('fk_users_unit', 'users', type_='foreignkey')
