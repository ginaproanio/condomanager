...
def upgrade():
    ...
    # --- ORDEN CORREGIDO ---
    # 1. Crear tablas sin dependencias o con dependencias mínimas
    ...
    op.create_table('users',
        ...
        sa.Column('created_at', sa.DateTime(), nullable=True),
        # La FK a 'units' se crea después de que 'units' exista.
    ...
    # 3. Crear tablas que dependen de 'condominiums' y 'users'
    ...
    # 4. Añadir la columna 'unit_id' a 'users' ahora que 'units' existe
    ...
    # 5. Crear el resto de las tablas
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    # --- ORDEN CORREGIDO (inverso a la creación) ---
